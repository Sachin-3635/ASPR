...
export interface IBannerOps {
    getAllBanner(props: IDmswebasprProps): Promise<IBanner[]>;
    getBannerById(Id: string | number, props: IDmswebasprProps): Promise<IBanner>;
...
export default function BannerOps() {
    ...
    const getAllBanner = async (props: IDmswebasprProps): Promise<IBanner[]> => {
    ...
    const getBannerById = async (Id: string | number, props: IDmswebasprProps): Promise<IBanner> => {
    ...
    const getBanner = async (columnsToRetrieve: string, columnsToExpand: string, filters: string
        , orderby: { column: string, isAscending: boolean }, props: IDmswebasprProps): Promise<IBanner[]> => {
    ...
    const getTopBanner = async (columnsToRetrieve: string, columnsToExpand: string, filters: string
        , orderby: { column: string, isAscending: boolean }, top: number, props: IDmswebasprProps): Promise<IBanner[]> => {
