...
import { DetailsList, DetailsListLayoutMode, SelectionMode, IColumn, ShimmeredDetailsList } from "@fluentui/react";
            ...
            try {
                ...
                const mappedItems: IFileItem[] = [
                    ...subFolders
                        ...
                        .map((f: any) => ({
                            Name: f.Name, // short code (ERM, etc.)
                            FullName: f.ListItemAllFields?.FullName || f.Name, // ✅ custom field
                            TimeLastModified: f.TimeLastModified,
                            AuthorTitle: "",
                            IsFolder: true,
                            ServerRelativeUrl: f.ServerRelativeUrl,
