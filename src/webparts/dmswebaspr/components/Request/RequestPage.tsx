...
export default class RequestPage extends React.Component<IDmswebasprProps, any> {
    private _sp: any;
    private peoplePickerContext: IPeoplePickerContext;
    // export const RequestPage: React.Component<IDmswebasprProps> = (props: IDmswebasprProps) => {
