...
import styles from './ApsrdmsSolution.module.scss';
...
export default class DmsModule extends React.Component<IApsrdmsSolutionProps, IDmsModuleState> {
  constructor(props: IApsrdmsSolutionProps) {
    super(props);
    this.state = {
  ...
  public render(): React.ReactElement<IApsrdmsSolutionProps> {
