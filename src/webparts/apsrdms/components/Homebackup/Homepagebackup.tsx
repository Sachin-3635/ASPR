...
export const ASPRDMSHome: React.FC<IApsrdmsProps> = (props) => {
    ...
    const itemsPerPage = 4; // sliding window size
    ...
    const deleteItem = async (item: IFileItem) => {
        ...
        const deleteUrl = `${props.context.pageContext.web.absoluteUrl}/_api/web/${item.IsFolder ? "GetFolderByServerRelativeUrl" : "GetFileByServerRelativeUrl"
        ...
        try {
            ...
            const response = await fetch(deleteUrl, {
                method: "POST", // ✅ SharePoint expects POST with override
                headers: {
                    Accept: "application/json;odata=verbose",
            ...
            <div className="libraryContainer">
                ...
                <div className="libhead">
                    ...
                    <div className="dropdown">
                        ...
                        <div className={`dropdown-content ${isOpen ? "show" : ""}`}>
                            <a href="#" onClick={openModal}><span className="icon"><img src={Plus} alt="" /></span> New</a>
                ...
                <div className="librarySliderWrapper">
                    ...
                    <div className="sliderButtons">
                        <button onClick={nextLibrary} disabled={currentIndex === 0}>
                            <img src={leftblack} alt="" className="iconblack" />
                        </button>
                        <button
                            onClick={prevLibrary}
                            disabled={currentIndex + itemsPerPage >= libraries.length}
                        >
                            <img src={rightblack} alt="" className="iconblack" />
                        </button>
                    </div>
                </div>
